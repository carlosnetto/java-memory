...
public class BigProgram {
    private static final List<Object> memoryKeep = new ArrayList<>();
    ...
    private static void method0(int seed) {
        ...
        memoryKeep.add(data);
        long localSum = 0;
        localSum += (seed * 0) ^ data[0];
        localSum += (seed * 1) ^ data[1];
        localSum += (seed * 2) ^ data[2];
        localSum += (seed * 3) ^ data[3];
        localSum += (seed * 4) ^ data[4];
        localSum += (seed * 5) ^ data[5];
        localSum += (seed * 6) ^ data[6];
        localSum += (seed * 7) ^ data[7];
        localSum += (seed * 8) ^ data[8];
        localSum += (seed * 9) ^ data[9];
        localSum += (seed * 10) ^ data[10];
        localSum += (seed * 11) ^ data[11];
        localSum += (seed * 12) ^ data[12];
        localSum += (seed * 13) ^ data[13];
        localSum += (seed * 14) ^ data[14];
        localSum += (seed * 15) ^ data[15];
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Allocating memory and loading classes...");
        method0(0);
        method1(1);
        method2(2);
        method3(3);
