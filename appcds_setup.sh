...
#   1. Build BigProgram.jar via CreateBigProgram.sh
#   2. Run it briefly to dump the loaded class list
#   3. Create the shared archive (.jsa) from the class list
#
...
echo "=== Step 2: Dumping loaded class list ==="
